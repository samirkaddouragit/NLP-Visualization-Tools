...
#This function takes the data, an interest vector defined the same way as in the sunburster function, a variable of choice (should be categorical) var, a boolean variable to dictate if the user wants
#to observe an additional variable with "extra_dimension_average", and the numerical variable of choice average_variable
